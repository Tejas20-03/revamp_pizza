...
const ItemCard: React.FC<ItemCardProps> = ({
  ...
  return (
    <div
      className={`flex gap-3 p-2 rounded-lg shadow-[5px_0px_20px_rgba(0,0,0,0.1)] bg-white dark:bg-[#202020] transition-opacity duration-200 ${
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 p-1">
        <div className="flex items-center justify-between gap-2">
          <h3 className="text-[16px] font-bold line-clamp-2 dark:text-white">
          ...
          <div className="flex items-center gap-1">
            {isSuggestive ? (
              ...
              <>
                ...
                <span className="text-[14px] bg-[var(--primary-light)] rounded px-[4px] py-[3px] dark:text-white">
